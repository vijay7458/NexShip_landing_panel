        ...
        <>
            ...
            >
                <g>
                    <path
                        fill="#d1d0df"
                        d="m323.5 402.9.5 32.7c0 3.5 3.8 6.3 8.4 6.3l130-1c4.6 0 8.3-2.9 8.3-6.4l-.5-32.7c0-3.5-3.8-6.3-8.4-6.3l-130 1c-4.6 0-8.3 2.9-8.3 6.4z"
                        opacity={1}
                        data-original="#d1d0df"
                        className=""
                    />
                    <path
                        fill="#b5b5c6"
                        d="M446.1 395.7h24.5v40.6h-24.5z"
                        opacity={1}
                        data-original="#b5b5c6"
                    />
                    <path
                        fill="#1975c9"
                        d="M484.7 517.3H335.5c50.3 0 94.4-27.5 118.7-76.7l29.3-.2z"
                        opacity={1}
                        data-original="#f9a01e"
                        className=""
                    />
                    <path
                        fill="#60a9eb"
                        d="M454.2 440.6c-24.3 49.1-68.4 76.7-118.7 76.7h-23.1l-1.1-75.5zM492.2 277.1l-4.9 2-17.6-54.9-.2-.5c-3-5.7-8.8-9.3-15.2-9.5-8.8-.2-17.1 4.2-22 11.5l-.1.2c-5 8.8-6.9 19-5.4 29 1.5 9.6 5.6 34.7 7.3 44.8-2.3 1.3-4.6 2.8-6.7 4.4l-103.1 43.1-11.9 5-6.8 2.9-3.1 1.3-27.5-65.6c.8.1 1.6.1 2.5.2 9.8.8 21.3.2 29.8-4.3 1.3-.7 2.5-1.4 3.7-2.2 4.6-3.1 8.6-7 11.8-11.6.5-.7.9-1.3 1.3-2 .3-.5.6-1.1.9-1.6 1.9-3.4 3.3-7 4.2-10.6.1-.4.2-.8.3-1.3v-.2c3.9-18.4-4.4-38-21.7-47.5-21.2-11.7-47.9-4-59.5 17.2-2.1-5-4.5-10.8-7.1-17v-.1c-7.8-18.8-17-40.8-21.6-51.7l77-32.2c3.3-1.4 5.3-4.6 5.1-8.2-.2-3.5-2.5-6.5-5.9-7.5-8-2.5-14.8-8-18.7-15.4-8.3-15.5-2.5-34.8 13-43.1s34.8-2.5 43.1 13c4.7 8.8 3.1 23.9 2.2 30-.2 1.6 0 3.3.6 4.8 1.9 4.6 7.3 6.9 11.9 4.9L421 73.8l78 186.6c2.7 6.5-.3 14-6.8 16.7z"
                        opacity={1}
                        data-original="#ffbb26"
                        className=""
                    />
                    <path
                        fill="#1975c9"
                        d="m271.5 297.9 27.8 66.4 195.2-81.6c9.6-4 14.1-15 10.1-24.6l-3.1-7.5c-8.4 4.1-17 8-25.7 11.7-64.6 27.1-134.4 39.2-204.3 35.6z"
                        opacity={1}
                        data-original="#f9a01e"
                        className=""
                    />
                    <path
                        fill="#efcdb1"
                        d="m491.1 310.8-17 63.8-.1-.1-.2.8c-.6 2.5-1.7 4.8-3.1 6.9 0 0-4.9 8.1-9.6 15.1l-125 .1c-10.9-9.9-17.2-23.9-17.5-38.6l-.2-9.1 5.9-2.5 103.1-43.1c2.1-1.6 4.3-3.1 6.7-4.4-1.7-10.1-5.8-35.1-7.3-44.8v-.2c1.3-.1 2.5-.2 3.8-.3 0-3.2.3-6.4 1.2-9.5.3-1.2.7-2.4 1.2-3.6.8-4.3 2.3-8.4 4.4-12.3 5.9-9.2 21.4-13 26.9-2.5z"
                        opacity={1}
                    ...
                    <path
                        fill="#d1d0df"
                        d="m190.5 126.4-.5-32.7c0-3.5-3.8-6.3-8.4-6.3l-130 1c-4.6 0-8.3 2.9-8.3 6.4l.5 32.7c0 3.5 3.8 6.3 8.4 6.3l130-1c4.6 0 8.3-2.8 8.3-6.4z"
                        opacity={1}
                        data-original="#d1d0df"
                        className=""
                    />
                    <path
                        fill="#b5b5c6"
                        d="M43.3 93h24.5v40.6H43.3z"
                        opacity={1}
                        data-original="#b5b5c6"
                    />
                    <path
                        fill="#05becc"
                        d="M29.3.1h149.2C128.2.1 84.1 39.6 59.8 88.8l-29.4.2z"
                        opacity={1}
                        data-original="#05becc"
                    />
                    <path
                        fill="#01c6e1"
                        d="M59.8 88.7C84.1 39.6 128.2.1 178.5.1h23.1l1.1 87.5z"
                        opacity={1}
                        data-original="#01c6e1"
                        className=""
                    />
                    <path
                        fill="#c11f2f"
                        d="M305.9 278.9c-9.8 5.5-25.4 4.7-33.6 3.7-1.7-.2-3.2 1-3.4 2.7-.1.6 0 1.1.2 1.6l29.6 66.2c3 6.7 0 14.6-6.7 17.7-19.3 8.6-54.3 24.3-69.2 31-1.2.5-2.6 0-3.1-1.2-.3-.6-.3-1.4 0-2 9.2-18.7 1.5-41.4-17.2-50.6s-41.4-1.5-50.6 17.2c-4.4 9-5.1 19.3-1.9 28.8 3.6 10.7 15.8 20.4 22.6 25.1 1.4 1 1.8 2.9.8 4.3-.3.5-.8.8-1.3 1.1l-77.9 34.9L73.9 414c65.9-48.4 109.8-135 109.8-233.8 0-4.4-.1-8.8-.3-13.2l16.5-7.4c5.7-2.5 12.3 0 14.9 5.7 8.5 18.9 24.8 55.5 31.7 70.9.5 1.2 1.9 1.7 3.1 1.2.6-.3 1.1-.8 1.3-1.5 5.6-20.1 26.5-31.9 46.6-26.2s31.9 26.5 26.2 46.6c-2.8 9.5-9.1 17.6-17.8 22.6z"
                        opacity={1}
                        data-original="#c11f2f"
                        className=""
                    />
                    <path
                        fill="#efcdb1"
                        d="m187.6 158.4-80.2 35.9-10.1-4.7c-1.9 4.1-4 8.1-6.1 11.9-.3.6-.7 1.1-1 1.7-1.8 3.1-3.9 5.8-6.1 8-6.3 6.4-13 9.3-13.1 9.3l-4.4 1.8.5 3.1.3 1.6c.1.4 6.1 36.9 8 49 1.1 7.2-.2 14.5-3.8 20.9-2.6 3.7-6.8 6-11.3 6-2 .1-3.9-1-4.9-2.7l-19.5-60.9-1.8-5.8-1.8-5.8-3.1-9.6 16.5-62c.5-1.8 1.6-4.3 2.6-5.9l.1-.2c0-.1 3-4.9 6.5-10.4l121.6-1c5.2 5.9 9 12.6 11.1 19.8z"
                        opacity={1}
                        data-original="#efcdb1"
                        className=""
                    />
                    ...
                    />
                    <path
                        d="m123.372 475.73 10.668-5.496 13.832 26.848-10.668 5.496zM37.183 497.01l13.832-26.848 10.668 5.496-13.832 26.847zM86.358 518.007l.755-30.2 12 .3-.755 30.2zM377.483 22.67l10.668-5.497 13.832 26.848-10.668 5.496zM463.672 43.935l13.831-26.847 10.668 5.496L474.34 49.43zM426.353 31.37l.755-30.2 12 .3-.755 30.2z"
                        fill="#000000"
                        opacity={1}
                        data-original="#000000"
                        className=""
