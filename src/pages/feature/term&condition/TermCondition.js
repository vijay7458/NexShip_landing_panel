...
export default function TermCondition() {
  return (
    <div style={{ backgroundColor: "#f8f9fa", color: "#222", minHeight: "100vh" }}>
      ...
      {/* Hero Section */}
      <div
        className="container-fluid w-100 position-relative d-flex justify-content-center align-items-center"
        style={{
          height: "300px",
      ...
      >
        <p className="text-center display-6 fw-bold" >Terms & Conditions</p>
      </div>
      ...
      <div className="container my-4">
        <div className="card shadow-sm border-0 p-4 p-md-5" style={{ borderRadius: "16px"}}>
          <div className="card-body">
            ...
            <h4 className="fw-bold mt-4 mb-3">2. User Responsibilities</h4>
            <ul>
            ...
            <h4 className="fw-bold mt-4 mb-3">3. Privacy Policy</h4>
            <p>
              We value your privacy and are committed to protecting your personal data.
              Our <strong>Privacy Policy</strong> explains how we collect, use, and safeguard the information you share with us.
              By using this website, you consent to our data collection and usage practices described therein.
            </p>

            <h4 className="fw-bold mt-4 mb-3">4. Intellectual Property</h4>
            <p>
            ...
            <h4 className="fw-bold mt-4 mb-3">5. Limitation of Liability</h4>
            <p>
            ...
            <h4 className="fw-bold mt-4 mb-3">6. Governing Law</h4>
            <p>
            ...
            <h4 className="fw-bold mt-4 mb-3">7. Changes to Terms</h4>
            <p>
            ...
            <h4 className="fw-bold mt-4 mb-3">8. Contact Us</h4>
            <p>
              If you have any questions or concerns about these Terms and Conditions, please reach out to our support team:
            </p>
            <ul>
              <li><strong>Email:</strong> sales@shipease.in</li>
              <li><strong>Business Hours:</strong> Monday – Friday, 9:00 AM to 6:00 PM</li>
            </ul>
